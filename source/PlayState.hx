	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'obscure': //Week 1
				...
				add(amogusBG);
			case 'mac': //Week 1
				var macBG:BGSprite = new BGSprite('bambi/mac', -280, -50, 0, 0);
				macBG.setGraphicSize(Std.int(macBG.width * 2.5));
				macBG.setGraphicSize(Std.int(macBG.height * 2.5));
				macBG.shader = the3DWorldEffectFlag.shader;
				add(macBG);
			case 'futile': //Week 1
